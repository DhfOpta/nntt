...
<>
    <div className="contenr">
        <div className="mainContn">
            {/* <div className="leftProdcutFltr"></div> */}
                  <div className="rghtProductyShow">
                      <div className='dataDply'>
                          <div>
                              <div className='cardContnt'>
                                  <Image alt='logo' src={tshirt} width={296} height={298} className='image' />
                              </div>
                      ...
                      <div className='dataDply'>
                          <div>
                              <div className='cardContnt'>
                                  <Image src={tshirt} alt='logo' width={296} height={298} className='image' />
                              </div>
                              <div className='cardDetal'>
                                  <div className='cardTitle'><p>T-SHIRT WITH TAPE DETAILS</p></div>
                                  <div className='cardRateng'><p>4.5</p></div>
